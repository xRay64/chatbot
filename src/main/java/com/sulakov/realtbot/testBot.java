...
public class testBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage()) {
            ...
            String callType = "";
            String callValue = "";
            if (call_data.contains("_")) {
                callType = call_data.substring(0, call_data.indexOf('_'));
                callValue = call_data.substring(call_data.indexOf('_') + 1);
            }
